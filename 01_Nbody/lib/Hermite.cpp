#include "Hermite.hpp"
         ...
         std::vector<Body> Hermite::integrate(const std::vector<Body>* bodies, const double maxTimeStep){
            ...
            for(Body current_body : *bodies)
            {
                ...
                Vector3d initial_acceleration = Tools::calc_acceleration_3dvec(*bodies,current_body);
                ...
                Vector3d predicted_acceleration = Tools::calc_acceleration_3dvec(*bodies,predicted_body);
